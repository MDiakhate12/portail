            ...
            >
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        name="frontend_project_repository"
                        placeholder="url of the frontend code repo"
                        value={frontend_project_repository || ''}
                        onChange={(e) => formDispatch(handleChange(e))}
                        // error={!!formErrors.projectName}
                        // helperText={formErrors.projectName}
                        required
                        ...
                        <>
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    value={backend_project_repository || ''}
                                    onChange={(e) => formDispatch(handleChange(e))}
                                    // error={!!formErrors.projectName}
                                    // helperText={formErrors.projectName}
                                    required
                ...
                <Grid item xs={12} sm={6}>
                    <MultipleCheckSelect
                        ...
                        names={dependencies.map(dep => ({ value: dep, display: dep.charAt(0).toUpperCase() + dep.slice(1)  }))}
                    />
                </Grid>
